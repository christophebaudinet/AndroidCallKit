package zenitconcept.hauslife.com.callui;
...
public class VoiceFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getData().size() > 0) {
            ...
            VoiceFirebaseMessagingService.this.notify(notificationId);
            VoiceFirebaseMessagingService.this.sendCallInviteToActivity(notificationId);
    ...
    private void notify(int notificationId) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            Notification notification =
                    buildNotification("test is calling.",
                            pendingIntent,
                            extras);
            ...
            NotificationCompat.Builder notificationBuilder =
                    new NotificationCompat.Builder(this)
                            ...
                            .setContentText("test is calling.")
                            .setAutoCancel(true)
                            .setExtras(extras)
    ...
    private void sendCallInviteToActivity(int notificationId) {
        Intent intent = new Intent(this, VoiceActivity.class);
        intent.setAction(VoiceActivity.ACTION_INCOMING_CALL);
        intent.putExtra(VoiceActivity.INCOMING_CALL_NOTIFICATION_ID, notificationId);
        //intent.putExtra(VoiceActivity.INCOMING_CALL_INVITE, callInvite);
